...
pos = data[(df['Hotel_Name'] == selected_hotel) & (df['year'] == selected_year) & (data['score'] > .8)].reset_index()
...
neg = data[(df['Hotel_Name'] == selected_hotel) & (df['year'] == selected_year) & (data['score'] < .3)].reset_index()
